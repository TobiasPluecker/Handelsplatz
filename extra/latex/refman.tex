...
\vspace*{7cm}
\begin{center}%
{\Large Logik Handelsplatz \\[1ex]\large 3 }\\
\vspace*{1cm}
...
\input{namespaceHandelsplatz}
\chapter{Klassen-\/\+Dokumentation}
\input{classHandelsplatz_1_1Angebot}
\input{classHandelsplatz_1_1Artikel}
\input{classHandelsplatz_1_1Haendler}
\input{classHandelsplatz_1_1Markt}
